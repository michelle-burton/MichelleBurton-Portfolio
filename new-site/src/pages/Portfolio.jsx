            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                    <div class="design-item" data-category="code">
                        <div class="col">
                        <a href="https://stock-tracker-2tc9.onrender.com/Total%20Return%20Tracker/index.html" target="_blank"><img src="images/Thumb_09.png" alt="Stock Tracker"/></a>
                ...
                <div class="col">
                <div class="card design-item" data-category="code">
                    <a href="dog-viewer/index.html"><img src="images/Thumb_08.png" class="img-fluid" alt="Dog Viewer API"/></a>
                 ...
                 <div class="col">
                    <div class="design-item" data-category="illustrations">
                        <a href="design/index.html?id=3"><img src="images/Thumb_03.png" alt="Creative Illustration"/></a>
                        <div class="overlay"><a href="design/index.html?id=3">View Design</a></div>
                    </div>
                </div>
                 <div class="col">
                    <div class="design-item" data-category="ui-kits">  
                    <a href="design/index.html?id=6"><img src="images/Thumb_06.png" alt="Mobile UI Kit"/></a>
                    <div class="overlay"><a href="design/index.html?id=6">View Design</a></div>
                    </div>
                </div>
                 <div class="col">
                    <div class="card design-item"  data-category="code">
                            <a href="code-task-list/index.html"><img src="images/Thumb_07.png" class="img-fluid" alt="Code Project"/></a>
                            <div class="overlay"><a href="code-task-list/index.html">View Feature</a></div>
                    </div>
                </div>
                <div class="col">
                    <div class="card design-item"  data-category="illustrations">
                            <a href="design/index.html?id=4"><img src="images/Thumb_04.png" class="img-fluid" alt="Illustration"/></a>
